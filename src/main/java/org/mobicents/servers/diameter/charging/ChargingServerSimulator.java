...
public class ChargingServerSimulator extends CCASessionFactoryImpl implements NetworkReqListener, EventListener<Request, Answer> {
  ...
  public void doCreditControlRequest(ServerCCASession session, JCreditControlRequest request) throws InternalException {
    ...
    switch (request.getRequestTypeAVPValue()) {
      ...
      case 2:
        ...
        try {
          processCCR(session, request, ccrAvps);
        }
        catch (Exception e) {
      ...
      case 4:
        ...
        try {
          ...
          logger.error(">< Failure processing Credit-Control-Request [EVENT]", e);
        }
        break;
  ...
  private void processCCR(ServerCCASession session, JCreditControlRequest request, AvpSet ccrAvps)
      throws AvpDataException, InternalException, IllegalDiameterStateException, RouteException, OverloadException {
    JCreditControlAnswer cca;
