...
RUN_CLASSPATH="$TEST_CORE/target/ocs_stub-1.0.0-SNAPSHOT-jar-with-dependencies.jar"
MANIFEST_MAIN_CLASS="org.mobicents.servers.diameter.charging.ChargingServerSimulator"
...
executeTest(){
      ...
      echo ""
      echo "$JAVA $JAVA_OPTS -classpath $RUN_CLASSPATH $MANIFEST_MAIN_CLASS $*"
      echo ""
      echo "========================================================================="
